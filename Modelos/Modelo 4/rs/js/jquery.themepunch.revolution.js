		...
		var prepareSlides = function(container,opt) {
			...
			container.find('>ul:first >li').each(function(j) {
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						...
						linktoslide="no";
						li.append('<div class="tp-caption sft slidelink" style="width:100%;height:100%;z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a style="width:100%;height:100%;display:block" target="'+target+'" href="../../rs-plugin/js/'+link+'"><span style="width:100%;height:100%;display:block"></span></a></div>');
					}
			...
			container.find('>ul:first >li >img').each(function(j) {
				...
				if (isIE(8)) {
					...
					pari.find('.tp-bgimg').append('<img class="ieeightfallbackimage defaultimg" src="../../rs-plugin/js/'+src+'" style="width:100%">');
				}
			   ...
			   if (isIE(8)) {
				...
				if (vorh == "horizontal") {
					...
					for (var i=0;i<opt.slots;i++) {
							...
							if (isIE(8)) {
							   sh.find('.slot ').last().find('.slotslide').append('<img class="ieeightfallbackimage" src="../../rs-plugin/js/'+imgsrc+'" style="width:100%;height:auto">');
				...
				for (var j=0;j<opt.slots;j++) {
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						if (isIE(8)) {
							...
							sh.find('.slot ').last().find('.slotslide').append('<img src="../../rs-plugin/js/'+imgsrc+'">');
							ieimgposition(sh,opt);
						}
		...
		var nextli = container.find('>ul:first-child >li:eq('+opt.next+')'),
			...
			nextsh.find('.defaultimg').each(function() {
				...
				if (nextsh.find('.kenburnimg').length==0)
					nextsh.append('<div class="kenburnimg" style="position:absolute;z-index:1;width:100%;height:100%;top:0px;left:0px;"><img src="../../rs-plugin/js/'+defimg.attr('src')+'" style="-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;position:absolute;width:'+imgobj.w+'%;height:'+imgobj.h+'%;"></div>');
				else {
		...
		**************************************************************************/
		...
		var createThumbs = function(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb" style="background-color:'+bgcolor+';position:relative;width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;background-image:url('../../rs-plugin/js/+src+') !important;background-size:cover;background-position:center center;"></div>');
							var bullet= bullets.find('.bullet:first');
				});
